...
### Traditional Query
SELECT [o].[Id], [o].[CreatedAt], [o].[CustomerName], [o].[OrderDate], [o].[Timestamp], [o].[UpdatedAt], [o0].[Id], [o0].[CreatedAt], [o0].[ItemName], [o0].[OrderId], [o0].[Price], [o0].[Quantity], [o0].[Timestamp], [o0].[Total], [o0].[UpdatedAt]
FROM [Orders] AS [o]
...
### Traditional Query
SELECT [t].[Id], [t].[CreatedAt], [t].[CustomerName], [t].[OrderDate], [t].[Timestamp], [t].[UpdatedAt], [o0].[Id], [o0].[CreatedAt], [o0].[ItemName], [o0].[OrderId], [o0].[Price], [o0].[Quantity], [o0].[Timestamp], [o0].[Total], [o0].[UpdatedAt]
 FROM (
     SELECT TOP(1) [o].[Id], [o].[CreatedAt], [o].[CustomerName], [o].[OrderDate], [o].[Timestamp], [o].[UpdatedAt]
     FROM [Orders] AS [o]
     WHERE [o].[Id] = @__id_0
 ) AS [t]
...
### Json Linq Query
 SELECT TOP(1) [o].[Id], [o].[CreatedAt], [o].[CustomerName], [o].[OrderDate], [o].[Timestamp], [o].[UpdatedAt], JSON_QUERY([o].[OrderDetailsJson],'$')
FROM [OrderWithOrderDetails] AS [o]
WHERE [o].[Id] = @__id_0
### Benchmark Test Result
...
SELECT [o].[Id], [o].[CreatedAt], [o].[CustomerName], [o].[OrderDate], [o].[Timestamp], [o].[UpdatedAt], [o0].[Id], [o0].[CreatedAt], [o0].[ItemName], [o0].[OrderId], [o0].[Price], [o0].[Quantity], [o0].[Timestamp], [o0].[Total], [o0].[UpdatedAt]
 FROM [Orders] AS [o]
 LEFT JOIN [OrderDetails] AS [o0] ON [o].[Id] = [o0].[OrderId]
 WHERE [o].[Id] IN ('fcfb1215-41f5-ed11-9f05-f46b8c8f0ef6', 'b6fd1215-41f5-ed11-9f05-f46b8c8f0ef6', '01fa1215-41f5-ed11-9f05-f46b8c8f0ef6')
 ORDER BY [o].[Id]
...
### Traditional Query
SELECT CAST(AVG([o0].[Price]) AS float(24))
FROM [Orders] AS [o]
INNER JOIN [OrderDetails] AS [o0] ON [o].[Id] = [o0].[OrderId]
...
### Traditional Query
SELECT CAST(COALESCE(SUM([o0].[Total]), 0.0E0) AS float(24))
FROM [Orders] AS [o]
INNER JOIN [OrderDetails] AS [o0] ON [o].[Id] = [o0].[OrderId]
WHERE [o].[Id] = @__id_0
...
### Traditional Query
 ...
 SET NOCOUNT ON;
 INSERT INTO [Orders] ([CreatedAt], [CustomerName], [OrderDate], [UpdatedAt])
...
(@p16, @p17, @p18, @p19, @p20, @p21, 2)) AS i ([CreatedAt], [ItemName], [OrderId], [Price], [Quantity], [UpdatedAt], _Position) ON 1=0
WHEN NOT MATCHED THEN
INSERT ([CreatedAt], [ItemName], [OrderId], [Price], [Quantity], [UpdatedAt])
VALUES (i.[CreatedAt], i.[ItemName], i.[OrderId], i.[Price], i.[Quantity], i.[UpdatedAt])
OUTPUT INSERTED.[Id], INSERTED.[Timestamp], INSERTED.[Total], i._Position;

### Json Linq Query
SET IMPLICIT_TRANSACTIONS OFF;
SET NOCOUNT ON;
INSERT INTO [OrderWithOrderDetails] ([OrderDetailsJson], [CreatedAt], [CustomerName], [OrderDate], [UpdatedAt])
 OUTPUT INSERTED.[Id], INSERTED.[Timestamp]
...
SELECT TOP(1) [o].[Id], [o].[CreatedAt], [o].[CustomerName], [o].[OrderDate], [o].[Timestamp], [o].[UpdatedAt]
FROM [Orders] AS [o]
WHERE [o].[Id] = @__orderDetailsDto_Id_0
) AS [t]
LEFT JOIN [OrderDetails] AS [o0] ON [t].[Id] = [o0].[OrderId]
ORDER BY [t].[Id]
...
SET IMPLICIT_TRANSACTIONS OFF;
SET NOCOUNT ON;
UPDATE [OrderWithOrderDetails] SET [OrderDetailsJson] = @p0, [CustomerName] = @p1, [UpdatedAt] = @p2
